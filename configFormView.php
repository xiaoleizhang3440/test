...
<style>
	...
	h1{
		...
		body, button, input, select, textarea { font-size: 16px;font-family: THeiti,"微软雅黑",Arial, Helvetica, sans-serif;word-break: break-all;word-wrap: break-word;color: #666;resize: none;outline: none;}
 ...
 * @Last Modified time: 2018-01-21 12:34:29
 */
...
echo "<tr>";
	echo "<td align='center' colspan='10'><h2>宝钢特钢物流运输（汽车）车辆调配单（代合同）</h2></td>";
echo "</tr>";

	echo "<tr><td colspan='10'><h2>托运单位：".$delegate_unit."  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;联系人: ".$delegate_person."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  电话 :26032555  &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;地址：水产路1251  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;托运单序号： ".$consignment_ID."</h2></td></tr>";

	echo "<tr>";
	echo "<td>品名</td><td>合同号</td><td>件数</td><td>每件体积</td><td>钢种</td><td>委托总吨位</td><td>需要车种</td><td>需要车辆数</td><td colspan=2>求运输起止时间（按24小时计）</td>";
	echo "</tr>";
	...
	echo "<td>".$goods_level."</td><td>总计人民币</td><td colspan=4>".$caculated_price."</td>";
	echo "</tr>";
...
echo "</table>";
	...
	echo "&nbsp;&nbsp;&nbsp;<a onclick='window.print();' style='cursor:pointer;'>打印</a>";
	echo "&nbsp;&nbsp;&nbsp;<a href=exportView.php?id=".$_GET["id"].">导出excel</a>";   